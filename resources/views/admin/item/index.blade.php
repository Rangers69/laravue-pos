                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="_method" value="PUT" v-if="editStatus">
                            ...
                            <div class="form-group">
                                ...
                                <option :selected="item.category_id == {{$category->id}}" value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <option :selected="item.unit_id == {{$unit->id}}" value="{{$unit->id}}">{{$unit->name}}</option>
                                @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                      ...
                      <div class="modal-footer justify-content-between">
                          <button type="button" class="btn btn-danger" v-if="editStatus" v-on:click="deleteData(item.id)">Delete</button>
